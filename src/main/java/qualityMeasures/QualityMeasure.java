...
/**
 * Override abstract class of cf4j library, used to simplify the evaluation of collaborative
 * filtering based recommendation
 */
public abstract class QualityMeasure extends es.upm.etsisi.cf4j.qualityMeasure.QualityMeasure {
