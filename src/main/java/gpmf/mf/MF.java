...
public class MF extends Recommender {
     ...
     */
    public MF(DataModel datamodel, Tree tree, int numFactors, int numIters, double regularization, double learningRate) {
        this(datamodel, tree, numFactors, numIters, regularization, learningRate, System.currentTimeMillis());
    }
     ...
     */
    public MF(DataModel datamodel, Tree tree, int numFactors, int numIters, double regularization, double learningRate, long seed) {
        super(datamodel);
